           ...
           newRow.innerHTML = `
               <div class="step_sec">
                   ...
                   <div style="padding: 5px;">
                       <button class="delete_btn" type="button"><img src="img/ion_trash-sharp.png" alt=""></button>
                   </div>
               </div>
               <div class="step_detail">
                   <div class="section_3_img">
                       <img src="" alt="요리순서사진" width="207px" height="220px">
                   </div>
                   <textarea type="text" class="explan" placeholder="설명쓰기"></textarea>
               </div>
           `;
